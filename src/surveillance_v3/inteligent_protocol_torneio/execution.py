...
from .inteligent_mobility_protocol_torneio import PointOfInterest, drone_protocol_factory
...
def main():
    ...
    logging.basicConfig(
        level=logging.INFO,  
        filename=f'surveillance_v3/logs/inteligent_protocol_torneio/cluster1_size100_mask05/simulation.log', 
        filemode='w', 
