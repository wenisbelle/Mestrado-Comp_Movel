...
from .random_max_uncertainty import PointOfInterest, drone_protocol_factory
...
def main():
    ...
    logging.basicConfig(
        level=logging.INFO,  
        filename=f'/Comp_mov/src/surveillance_v3/logs/article/16UAV_200A/max_uncertainty/simulation.log', 
        filemode='w', 
